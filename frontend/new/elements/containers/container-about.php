  ...
  <div class="breadcrumb-container">
    <div class="row">
      <div class="large-12 column">
        <nav class="breadcrumbs animated bounceInDown"><a href="<?php echo $siteurl; ?>">Home</a> <a class="current" href="#">About Us</a></nav>
      </div>
    </div>
  </div>
  <section class="part">
    ...
    <div class="row">
      <div class="large-12 column">
        ...
        <img src="<?php echo $site_url ;?>/static/images/demo/about.jpg" alt=""></div>
    </div>
  </section>
</section>
